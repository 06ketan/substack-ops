...
This Code of Conduct applies within all project spaces (issue tracker, pull
requests, discussions, chat) and also applies when an individual is officially
